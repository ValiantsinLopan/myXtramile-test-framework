...
namespace Framework.UI.Pages
{
    public class LoginPage
    {
        ...
        private IWebElement FullNameInput => DriverFactory.Driver.FindElement(By.XPath("//input[@id='ember527']"));
        private IWebElement EmailInput => DriverFactory.Driver.FindElement(By.XPath("//input[@id='ember528']"));
        private IWebElement NewUserPasswordInput => DriverFactory.Driver.FindElement(By.XPath("//input[@id='ember533']"));
        private IWebElement CompanyNameInput => DriverFactory.Driver.FindElement(By.XPath("//input[@id='ember538']"));
